...
// //   //   const dueHour = taskEndTime.getHours() + taskEndTime.getMinutes()/60; 

// //   //   const diffInHours = Math.abs((((taskEndTime.getDate() - currentTime.getDate()) * 24) + (dueHour - currentHour)) % 24);

  
// //   //   console.log(`Task end time: ${taskEndTime}, Current time: ${currentTime}, Difference in hours: ${diffInHours}`);
  
// //   //   if (diffInHours <= 0) {
// //   //     color = 'black'; // Due time has passed
// //   //   } else if (diffInHours > 0 && diffInHours <= 24) {
// //   //     color = 'red'; // Due in 24 hours or less
// //   //   } else if (diffInHours > 24 && diffInHours <= 72) {
// //   //     color = '#ff5b00'; // Due between 24 and 72 hours
// //   //   } else {
// //   //     color = 'green'; // Due in more than 72 hours
// //   //   }
...
// //     // Calculate difference in days and hours
// //     const diffInDays = taskEndTime.getDate() - currentTime.getDate();
// //     const diffInHours = Math.abs(((diffInDays * 24) + (dueHour - currentHour)) % 24);
  
// //     const totalDiffInHours = (diffInDays * 24) + diffInHours;
  
// //     console.log(`Task end time: ${taskEndTime}, Current time: ${currentTime}, Difference in days: ${diffInDays}, Difference in hours within 24h: ${diffInHours}, Total difference in hours: ${totalDiffInHours}`);
  
// //     if (totalDiffInHours <= 0) {
// //       color = 'black'; // Due time has passed
// //     } else if (totalDiffInHours > 0 && totalDiffInHours <= 24) {
// //       color = 'red'; // Due in 24 hours or less
// //     } else if (totalDiffInHours > 24 && totalDiffInHours <= 72) {
// //       color = '#ff5b00'; // Due between 24 and 72 hours
// //     } else {
// //       color = 'green'; // Due in more than 72 hours
// //     }
...
//     console.log(`Task end time: ${taskEndTime}, Current time: ${currentTime}, Total difference in hours: ${diffInHours}`);
