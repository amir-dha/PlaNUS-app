...
//                 navigation.navigate('AddTaskEventScreen', { type: 'task' }); }} style={styles.modalOption}>
//               <Text style={styles.modalOptionText}>TASK</Text>
//             </TouchableOpacity>
//             <TouchableOpacity onPress={() => { setAddEventModalVisible(false);
//                 navigation.navigate('AddTaskEventScreen', { type: 'event' }); }} style={styles.modalOption}>
  ...
  return (
    <View style={styles.container}>
      ...
      {showDropdown && (
        <View style={styles.dropdown}>
          <View style={styles.toggleContainer}>
            <TouchableOpacity onPress={() => navigation.navigate('CalendarGridScreen')}>
              <Text style={[styles.toggleText, viewType === 'grid' && styles.selectedToggleText]}>GRID</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setViewType('list')}>
              <Text style={[styles.toggleText, viewType === 'list' && styles.selectedToggleText]}>LIST</Text>
        ...
        <TouchableOpacity style={styles.modalOverlay} onPress={() => setAddEventModalVisible(false)}>
          <View style={styles.modalContainer}>
            <TouchableOpacity onPress={() => { 
                ...
                navigation.navigate('AddTaskEventScreen', { type: 'task' });
              }} style={styles.modalOption}>
              <Text style={styles.modalOptionText}>TASK</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => { 
                setAddEventModalVisible(false);
                navigation.navigate('AddTaskEventScreen', { type: 'event' });
              }} style={styles.modalOption}>
              <Text style={styles.modalOptionText}>EVENT</Text>
            </TouchableOpacity>
          </View>
