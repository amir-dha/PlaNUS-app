...
//   const scheduleNotification = async (notificationTime, title, body) => {
...
//       const notificationTitle = isTask ? `Task: ${title} Due` : `Event: ${title} Starting`;
//       const notificationBody = isTask
//         ? `Due at ${endDateTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true })}`
//         : `Starts at ${startDateTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true })}`;
...
//         await scheduleNotification(urgentNotificationTime, notificationTitle, notificationBody);
//       }
...
//             notificationTime = new Date(startDateTime);
...
//             break;
//         }
//         await scheduleNotification(notificationTime, notificationTitle, notificationBody);
//       });
